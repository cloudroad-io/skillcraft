<!-- skillcraft:managed-source path=AGENTS.md sha=a14d40a3f471 -->

---
name: skillcraft
description: Lint, sync and scaffold agent-config files (SKILL.md, CLAUDE.md, AGENTS.md).
  Use when checking, validating or regenerating agent-config files in a repository.
---
